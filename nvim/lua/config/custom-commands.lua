...
--
-- pseudocode:
-- start = find ( on current line in front of cursor
-- if start = nil
--   start =look if cursor is inside ()
-- if start = nil
--   do nothing, abort
-- end = find matching )
-- if end = nil
--  do nothing, abort
-- perform action on text between ()
-- 
--
--
local function multiline()
  ...
  -- local end_pos = vim.fn.search("\\)", "bW")
  -- print(start)
  -- print(end_pos)
end

vim.keymap.set("n", "<leader>ma", multiline)
